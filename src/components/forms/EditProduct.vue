...
const { errors, defineInputBinds, isSubmitting, handleSubmit } = useForm({
    ...
    initialValues: {
        ...
        salePrice: props.producto.salePrice,
        purchasePrice: props.producto.purchasePrice,
        barCode: props.producto.barCode,
        stock: props.producto.stock,
        brand: props.producto.brand,
        measureUnit: props.producto.measureUnit,
    }
})
...
const onSubmit = handleSubmit(async (values) => {
    ...
    // console.log(body);
    await storeProd.updateProducto(props.producto.id, body)
